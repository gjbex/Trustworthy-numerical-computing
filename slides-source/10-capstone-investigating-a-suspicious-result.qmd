...
| $\delta$ | $10^{-6}$ |
| Bound on each reading | $\pm5\times10^{-8}$ |
...
## The Stable Total And Unstable Split
...
> reference to $1.15\times10^{-11}\ \mathrm{mg/L}$.

But:

- $\kappa_2(A)\approx4.00\times10^6$
- $c_A\in[0.50,0.70]\ \mathrm{mg/L}$ over the input bounds
